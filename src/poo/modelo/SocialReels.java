...
public class SocialReels extends ContenidoAudiovisual{
     ...
     public SocialReels(String titulo, int duracionEnMinutos, String genero, int numerodereacciones) {
         super(titulo, genero, duracionEnMinutos, numerodereacciones);
    	 this.Nombredelreels();
     ...
     return "Detalles de la SocialReels" + ","  + this.getId() + ","  + this.getTitulo() + "," + this.getDuracionEnMinutos() + "," + this.getGenero() + ","  + this.numerodereacciones;
     }
